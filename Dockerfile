...
LABEL org.opencontainers.image.title="arremateai-userprofile"
LABEL org.opencontainers.image.description="Servico de perfis de usuario do ArremateAI"
LABEL org.opencontainers.image.vendor="ArremateAI"
LABEL org.opencontainers.image.source="https://github.com/Quintanilha09/arremateai-userprofile"
...
USER appuser
EXPOSE 8085
HEALTHCHECK --interval=30s --timeout=10s --retries=3 --start-period=40s     CMD curl -f http://localhost:8085/actuator/health || exit 1
